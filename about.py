...
Label(frame4, text="A GUI version of spotify-downloder of Ritiek Malhotra.")
Label(frame5, text="It can download music from YouTube in MP3 format and can play them.")
Label(frame6, text="It can download songs directly by typing name or typing the link.")
